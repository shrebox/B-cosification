...
from datasets.builder import (build_dataset, dataset_collection,
                                             get_dataset_collate_fn,
                                             get_dataset_collection_from_file,
                                             get_dataset_default_task)
from metrics import (captioning, image_caption_selection,
                                    linear_probe, zeroshot_classification,
                                    zeroshot_retrieval)
from model_collection import (get_model_collection_from_file,
                                             model_collection)
from models import MODEL_TYPES, load_clip
...
def get_parser_args():
    ...
    # B-cosification arguments
    parser_eval.add_argument('--cosine_power', default=1, type=int, help="cosine power for bcos models")
    parser_eval.add_argument('--experiment_path', default=None, type=str, help="path to the experiment folder")
