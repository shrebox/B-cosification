...
def parse_args():
    ...
    parser.add_argument(
        "--partition",
        default="gpu17,gpu20,gpu22,gpu24",
        type=str,
        help="Partition where to submit",
    )
    parser.add_argument("--cpus_per_task", default=16, type=int, help="Number of CPUs per task")
...
class RunExperiment:
    ...
    def __call__(self):
        ...
        bcos.training.training.run_training(copy.deepcopy(self.args))
